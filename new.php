        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="new.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Profile</a>
                    <a href="service_dashboard.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Service</a>
                    <!-- <a href="new2.html" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>design</a> -->
                ...
                <div class="col-12">
                    ...
                    // echo $col['Name'];
                     if (isset($col['id']) == null) { ?>
                        <!-- <h6 class="mb-4">profile Table</h6> -->


                        <!-- <a href="new1.php"><button class= "btn btn-sm btn-primary">Add <i class="fa fa-plus" aria-hidden="true"></i></button> -->

                        <div class="bg-secondary rounded h-100 p-4">
                        <div class="bg-secondary rounded h-100 p-4">
                        <div class="d-flex align-items-center justify-content-between">
                        <h1>profile</h1>
                        <a href="new1.php"><button class= "btn btn-sm btn-primary">Add <i class="fa fa-plus" aria-hidden="true"></i></button></a>
                        <a href="edit.php?id=<?php echo $col['id'] ?>"><button class= "btn btn-sm btn-primary">edit <i class="fa fa-edit" aria-hidden="true"></i></button></a>
                        <button class= "btn btn-sm btn-primary" id="trash" value="<?php echo $col['id'] ?>">trash<i class="fa fa-trash" aria-hidden="true"></i></button>
                        ...
                        <!-- <i class="fa-solid fa-delete-left"></i> -->
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                  ...
                                  <td><?php echo $col['Profile']; ?></td>
                                  <td><?php echo $col['Email']; ?></td>
                                  <td><?php echo $col['P.no']; ?></td>
                                  <td><?php echo $col['Education']; ?></td>
                                  <td><?php echo $col['Branch']; ?></td>
                                  <td><?php echo $col['Place']; ?></td>
                                  <td><?php echo $col['Job type']; ?></td>
                                  <td><img src="<?php echo "upload/", $col['profile_image']; ?>" height="100px"width="100px"></td>
                                  <td><?php echo $col['About_Me']; ?></td>
