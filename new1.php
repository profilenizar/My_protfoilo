...
<body>
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="new.html" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Profile</a>
        ...
        <!-- Sign Up Start -->
        <!-- <form action="core1.php" method="post" >
                    ...
                    <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="index.html" class="">
                                <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>services</h3>
                            </a>
                        </div>
                        <div class="form-floating mb-2">
                            <input type="text" class="form-control" id="floatingText" placeholder="heading" name="heading">
                        ...
                        <div class="form-floating mb-2">
                            <input type="text" class="form-control" id="floatingbranch" placeholder="icon" name="icon">
                            <label for="floatingbranch">icon</label>
                        </div>

                       
                        <button type="submit" name="submit" class="btn btn-primary py-3 w-100 mb-2">Submit</button>
                    </div>
                </div>
            </div>
        </div>
